...
public class Main {
	...
	/*private static final String Location = Main.class.getResource("").toString().replaceAll("!/"+Main.class.getPackage().getName()+"/", "").replaceAll("jar:file:/", "");
	...
	public static void main(String[] args) throws Exception {
		...
		if(args.length == 1 && args[0].toLowerCase().equals("startgame")) {
			...
			try {
				...
				Runtime.getRuntime().exec(java+" -Djava.library.path=\"native\\"+osis+"\" -classpath .;Takyo.jar;lib/slick.jar;lib/jorbis-0.0.17-1.jar;lib/lwjgl_util.jar;lib/lwjgl.jar;lib/jogg-0.0.7.jar fr.tangv.takyo.game.Start startgame");
				System.exit(0);
			}catch (Exception e) {
				String text = "Echec le jeux n'a pas réussie à etre lancer: \n"+e.getCause();
				System.out.println(text);
